...
- Tests: `npm.cmd run test` passes with 31 test files / 260 tests.
...
- Latest validation: `npm.cmd run verify` passes with 31 files / 260 tests and production build, `npm.cmd run qa:viewport` passes 29 scenarios with all visible buttons named and at least 44x44px, `npm.cmd run qa:mobile-touch` passes a 38-step real-touch journey with 12 tracked attempts, and the local ElevenLabs audit passes at 1487/1487 current lines plus 32/32 reading phonemes.
