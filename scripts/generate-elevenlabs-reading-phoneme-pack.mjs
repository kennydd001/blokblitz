...
// Only isolated phonemes use these clips; zoemend lezen/word splitting stays on its separate fallback path.
  ...
  JSON.stringify(
    {
      ...
      scope: "isolated reading phonemes only; word splitting and zoemend lezen are excluded",
