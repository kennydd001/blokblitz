...
export const PLAY_MODES: PlayMode[] = [
  ...
  { scene: "schrijfspoor", emoji: "✏️", name: "Schrijfspoor", desc: "Trek de letter na", tone: "schrijfspoor", category: "lezen", track: "literacy", stage: 1, sequence: 3, domain: "literacy-writing", skills: ["letterForm"], targetPrefixes: ["write-"] },
  { scene: "luisterbos", emoji: "🌳", name: "Luisterbos", desc: "Luister het verhaaltje", tone: "luister", category: "lezen", track: "literacy", stage: 1, sequence: 4, domain: "listening-comprehension", skills: ["listeningQuestion"] },
  { scene: "zoemroute", emoji: "🐝", name: "Zoemroute", desc: "Zoem tot een woord", tone: "zoemroute", category: "lezen", track: "literacy", stage: 2, sequence: 5, domain: "literacy-reading", skills: ["wordRead"], targetPrefixes: ["word-"] },
  { scene: "woordbouwplaats", emoji: "🔤", name: "Woordbouw", desc: "Bouw het woord", tone: "woordbouw", category: "lezen", track: "literacy", stage: 2, sequence: 6, domain: "literacy-reading", skills: ["wordBuild"], targetPrefixes: ["build-"] },
